...
<div class="">
            ...
            <div class="toggle-estatus-materiales">
                ...
                <div class="">
                    ...
                    <img id="ValEstatus" src="../img/toggle_on_35px.png"
                        onclick="javascript:valStatus(); javascript:GetMateriales(); javascript:EstablecerPag()">
                </div>
            </div>
        </div>
                        ...
                        <th class=" col-1" style="width: 100px;">
                            <div class="d-flex align-items-center">
                                ...
                                <select class="form-select form-select-sm ml-2" id="selectUnidad"
                                    onchange="javacript:GetMateriales();EstablecerPag()"
    ...
    <div class="modal" id="confirmActivationModal" tabindex="-1" aria-labelledby="activationModalLabel"
        aria-hidden="true" style="z-index: 4000; color: #303030; top: 194px;">
        <div class="modal-dialog">
