...
<body>  
    <div class="top-bar">    
        <div id="logoImage" style="height: 70%;"></div>
            ...
            <span style="color: white; font-family: 'LatoBold', sans-serif; z-index: 1500; background-color: #008E5A;">Aqui va el usuario</span>
            ...
            <ul class="dropdown-menu"   style="background-color: #008E5A; border: 3px; border-color: #ffffff;">
                <li><a class="dropdown-item" style="color: #ffffff;" href="javascript:opcion('usuarios');">Usuarios</a></li>
