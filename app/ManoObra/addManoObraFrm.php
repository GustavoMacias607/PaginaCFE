        ...
        <div class="modal-content" style="border: 3px solid #008E5A;">
            ...
            <div class="modal-body modal-body-manodeobra">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" onblur="javascript:CompruebaTieneAlgoInput(this)"
                        class="form-control inputLleno" id="AddcantidadInputManodeobra">
                </div>
                <div class="mb-3">
        ...
        <div class="modal-content" style="border: 3px solid #008E5A;">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="precioInput" class="form-label" style="color: #303030;">Cantidad*</label>
                    <input type="number" class="form-control inputLleno"
                        onblur="javascript:CompruebaTieneAlgoInput(this)" id="UpdcantidadInput">
                </div>
                <div class="mb-3">
                    <label for="precioInput" class="form-label" style="color: #303030;">Rendimiento*</label>
                    <input type="number" class="form-control inputLleno"
                        onblur="javascript:CompruebaTieneAlgoInput(this)" id="UpdrendimientoInput">
                </div>
            </div>
            <div class=" modal-footer modal-footer-manodeobra">
